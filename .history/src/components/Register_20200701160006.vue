<template>
  <el-dialog title="注册" width="560px" :visible.sync="dialogVisible" @close="handleClose">
    <el-form :model="form" ref="form" label-width="80px" class="dialog-form">
      <el-form-item label="用户名" props="username" :rules="[{ required: true, message: '请输入用户名', trigger: 'blur' }]">
      ...
      <el-form-item label="确认密码" prop="coomPassword" :rules="[{ required: true, message: '请确认密码', trigger: 'blur' }, { validator: passwordValidator, trigger: 'blur' }]">
